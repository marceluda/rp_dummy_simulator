...
dm.add( fpga_reg(name='entrada'            , index= 20, rw=True , nbits= 3,signed=False) )
dm.add( fpga_reg(name='lpf_on'             , index= 21, rw=True , nbits= 1,signed=False) )
dm.add( fpga_reg(name='lpf_val'            , index= 22, rw=True , nbits= 4,signed=False) )
dm.add( fpga_reg(name='hpf_on'             , index= 23, rw=True , nbits= 1,signed=False) )
dm.add( fpga_reg(name='hpf_val'            , index= 24, rw=True , nbits= 4,signed=False) )
dm.add( fpga_reg(name='peak_pos'           , index= 25, rw=True , nbits=14,signed=True ) )
dm.add( fpga_reg(name='sg_amp'             , index= 26, rw=True , nbits=14,signed=True ) )
dm.add( fpga_reg(name='sg_width'           , index= 27, rw=True , nbits=14,signed=True ) )
dm.add( fpga_reg(name='sg_base'            , index= 28, rw=True , nbits=14,signed=True ) )
dm.add( fpga_reg(name='noise_enable'       , index= 29, rw=True , nbits= 1,signed=False) )
dm.add( fpga_reg(name='noise_amp'          , index= 30, rw=True , nbits=14,signed=True ) )
dm.add( fpga_reg(name='drift_enable'       , index= 31, rw=True , nbits= 1,signed=False) )
dm.add( fpga_reg(name='drift_time'         , index= 32, rw=True , nbits= 4,signed=False) )
dm.add( fpga_reg(name='val_fun'            , index= 33, rw=False, nbits=14,signed=True ) )
dm.add( fpga_reg(name='noise_std'          , index= 34, rw=False, nbits=14,signed=True ) )
dm.add( fpga_reg(name='read_ctrl'          , index= 35, rw=True , nbits= 3,signed=False) )
# [REGSET DOCK END]
